...
<br>
<div style="text-align: justify">
Finalmente, el autor detalla los coeficientes estimados de la DDD para la cohorte tratada en relación con una cohorte ligeramente mayor de 25 a 29 años. Es posible que la cohorte de 25 a 29 años esté demasiado cerca en edad para funcionar como un control satisfactorio dentro del estado; si los de 20 a 24 años tienen relaciones sexuales con los de 25 a 29 años, por ejemplo, entonces se viola la SUTVA. Solamente de forma ilustrativa, se presenta al final la tabla de regresion completa.
<div/>
